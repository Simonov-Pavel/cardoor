...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer(['admin.body.index', 'admin.car.form', 'car'], 'App\ViewsComposer\BodyComposer');
        View::composer(['admin.class.index', 'admin.car.form', 'car'], 'App\ViewsComposer\ClassCarComposer');
        ...
        View::composer(['car'], 'App\ViewsComposer\CarPageComposer');
    }
}
